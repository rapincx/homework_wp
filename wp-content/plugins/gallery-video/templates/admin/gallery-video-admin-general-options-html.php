				...
				<div id="videogallery-options-list">
					...
					<ul class="options-block" id="videogallery-view-tabs-contents">
						...
						<li id="videogallery-view-options-4">
							<img style="width: 100%;" src='<?php echo $path_site; ?>/thumbnails-tab5.png' >
						</li>
						<li id="videogallery-view-options-5">
							<img style="width: 100%;" src='<?php echo $path_site; ?>/justified-tab6.png' >
						</li>
						<li id="videogallery-view-options-6">
							<img style="width: 100%;" src='<?php echo $path_site; ?>/blockstyle-tab7.png' >
						</li>
					</ul>
